  ...
  return (
    <div className="bg-gradient-to-b from-brand-50 via-white to-brand-50 dark:from-brand-950 dark:via-brand-900/40 dark:to-brand-950 min-h-screen pt-32 pb-24 transition-colors duration-500 font-sans text-brand-950 dark:text-brand-50">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-[90rem] mx-auto mb-20 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        <div className="bg-gradient-to-br from-brand-950 to-brand-800 dark:from-brand-900 dark:to-brand-800 shadow-xl text-white rounded-[3rem] p-10 md:p-16 lg:p-24 relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
          <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-r from-brand-600 to-brand-400 shadow-md rounded-full blur-[100px] opacity-30 -translate-y-1/2 translate-x-1/2 group-hover:bg-brand-400 group-hover:scale-150 transition-all duration-1000"></div>
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
             <div>
                ...
                <div className="flex items-center gap-3 text-brand-200/80 font-medium mb-8">
                   ...
                   <span className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-brand-600 to-brand-400 shadow-md mx-2"></span>
                ...
                <Link to="#" className="group/btn inline-flex items-center space-x-4 bg-gradient-to-r from-brand-600 to-brand-400 shadow-md text-white px-8 py-4 rounded-full hover:bg-white hover:text-brand-950 transition-all shadow-lg hover:scale-105">  
