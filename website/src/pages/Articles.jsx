    ...
    <div className="bg-brand-50 dark:bg-brand-950 min-h-screen pt-32 pb-24 transition-colors duration-500 font-sans text-brand-950 dark:text-brand-50">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-[70rem] mx-auto text-center mb-24 animate-fade-in-up">
        <h1 className="text-5xl lg:text-7xl font-black text-brand-950 dark:text-white tracking-tighter mb-8 bg-clip-text">
          Insights <span className="text-brand-600 dark:text-brand-400">&</span> Articles
        </h1>
        <p className="text-xl lg:text-2xl text-brand-800/80 dark:text-brand-200/80 max-w-3xl mx-auto font-light leading-relaxed">
          Stay up to date with our latest thoughts, industry trends, and deep dives into the strategies that drive success.
        </p>
      </section>
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
             <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-md mb-8">
                   ...
                   <span className="text-xs font-semibold tracking-widest uppercase text-brand-100">Featured</span>
                </div>
                <h2 className="text-4xl lg:text-6xl font-black mb-6 tracking-tighter leading-tight group-hover:text-brand-200 transition-colors">
                  The 5-Step Framework to Scaling Your Revenue in 2026
                </h2>
                ...
                <p className="text-xl text-brand-50/80 font-light leading-relaxed mb-10 max-w-lg">
                  Scaling a business requires more than just hard work; it requires a systematic approach to customer acquisition and retention. In this article, we break down our proprietary model...
                </p>
                <Link to="#" className="group/btn inline-flex items-center space-x-4 bg-brand-600 text-white px-8 py-4 rounded-full hover:bg-white hover:text-brand-950 transition-all shadow-lg hover:scale-105">
                   <span className="text-lg font-bold">Read Full Article</span>
             ...
             <div className="h-full min-h-[400px] bg-brand-800 dark:bg-brand-950/50 rounded-[2rem] border-2 border-brand-600/30 overflow-hidden relative group-hover:border-brand-400/50 transition-all duration-500 flex items-center justify-center">
                ...
                <img src="https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" alt="Scaling Revenue" className="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-50 group-hover:scale-105 group-hover:opacity-70 transition-all duration-700" />
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-[90rem] mx-auto animate-fade-in-up" id="recent" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           ...
           <div className="bg-white dark:bg-brand-900 border-2 border-transparent p-8 rounded-[2rem] flex flex-col justify-between hover:border-brand-400 hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group">
              <div>
                <div className="h-48 rounded-xl bg-brand-100 dark:bg-brand-800 mb-6 overflow-hidden relative">
                   <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Organic Growth" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-80" />
                </div>
                <div className="text-sm font-bold text-brand-600 dark:text-brand-400 mb-3 flex items-center gap-2 uppercase tracking-wider">
                   Strategy <span className="w-1 h-1 rounded-full bg-brand-400"></span> April 5
                </div>
                ...
                <p className="text-brand-800/80 dark:text-brand-200/80 font-light leading-relaxed mb-6">
                  Explore the foundational strategies for building an audience without relying solely on paid ads...
                </p>
              </div>
              <Link to="#" className="inline-flex items-center text-brand-950 dark:text-white font-bold group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
                 Read Article <ArrowUpRight size={18} className="ml-1 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </Link>
           </div>
           ...
           <div className="bg-white dark:bg-brand-900 border-2 border-transparent p-8 rounded-[2rem] flex flex-col justify-between hover:border-brand-400 hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group">
              <div>
                <div className="h-48 rounded-xl bg-brand-100 dark:bg-brand-800 mb-6 overflow-hidden relative">
                   <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Market Shifts" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-80" />
                </div>
                <div className="text-sm font-bold text-brand-600 dark:text-brand-400 mb-3 flex items-center gap-2 uppercase tracking-wider">
                   Leadership <span className="w-1 h-1 rounded-full bg-brand-400"></span> March 28
                </div>
                <h4 className="text-2xl font-bold mb-4 text-brand-950 dark:text-white leading-tight group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
                  Navigating Market Shifts: A Guide for Leaders
                </h4>
                <p className="text-brand-800/80 dark:text-brand-200/80 font-light leading-relaxed mb-6">
                  How to pivot your business model efficiently when the economic climate changes unexpectedly...
                </p>
              </div>
              <Link to="#" className="inline-flex items-center text-brand-950 dark:text-white font-bold group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
                 Read Article <ArrowUpRight size={18} className="ml-1 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
           ...
           <div className="bg-white dark:bg-brand-900 border-2 border-transparent p-8 rounded-[2rem] flex flex-col justify-between hover:border-brand-400 hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group">
              <div>
                <div className="h-48 rounded-xl bg-brand-100 dark:bg-brand-800 mb-6 overflow-hidden relative">
                   <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Perfect Offer" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-80" />
                </div>
                <div className="text-sm font-bold text-brand-600 dark:text-brand-400 mb-3 flex items-center gap-2 uppercase tracking-wider">
                   Marketing <span className="w-1 h-1 rounded-full bg-brand-400"></span> March 20
                </div>
                <h4 className="text-2xl font-bold mb-4 text-brand-950 dark:text-white leading-tight group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
                  The Anatomy of a Perfect Offer
                </h4>
                <p className="text-brand-800/80 dark:text-brand-200/80 font-light leading-relaxed mb-6">
                  Learn how to craft irresistible offers that your prospects can't say no to, combining value and risk reversal...
                </p>
              </div>
              <Link to="#" className="inline-flex items-center text-brand-950 dark:text-white font-bold group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
                 Read Article <ArrowUpRight size={18} className="ml-1 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
